...
require_once "php/check_user.php";

session_start();

$name = $email = $pwd = $name_or_email = "";
$name = get_post('name');
$email = get_post('email');
$pwd = get_post('pwd');
$name_or_email = get_post('name_or_email');
...
if ($name_or_email != "") {
    $isUser = check_user($name_or_email, $pwd);
    if ($isUser) {
      ...
      <div class="modal__container close-modal__container" id="modal-container">
         ...
         <div class="form__container signin__container" id="signin">
            <form action="#">
                  ...
                  <input name="name_or_email" type="text" placeholder="Username or Email">
                  <input name="pwd" type="password" placeholder="Password">
